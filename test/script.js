...
function toE() {
  ...
  document.getElementById('ta1').innerHTML = '<textarea rows="8" cols="80" id="ta1" class="dragon" placeholder="Text to translate into English" style="margin-top: -20px;" spellcheck="false" value="">' + engStr + '</textarea>';
  // console.log(engStr)
}
// ree ree2 ree3
